...
public class EarthquakeCityMap extends PApplet {
	...
	// is used then changing map providers
	private int selectProvider = 1;
	...
	private void addKey() {	
		...
		fill(255, 255, 255);
		stroke(0);
		triangle(xbase+30, ybase+63, xbase+35, ybase+53, xbase+40, ybase+63);
		...
		textAlign(LEFT, CENTER);
		fill(0, 0, 0);
		text("Keyboard Shortcuts", xbase+14, ybase+225);
		text("1 Toggle between maps", xbase+14, ybase+245);
		text("2 Airports on/off", xbase+14, ybase+265);
		text("3 Cities on/off", xbase+14, ybase+285);
		text("4 Show only  ", xbase+14, ybase+305);
		text("  recent earthquakes", xbase+14, ybase+325);
		text("5 Show everything", xbase+14, ybase+345);
